...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 [_BASE] = LAYOUT_split_3x5_3(  // Default (大西配列mod)
   ...
   //|------------+-------------+-------------+--------------+-----------------+-------------------|  |-----------------+------------------+-----------------+-------------+-------------+-------------|
                                                       KC_ESC, LT(_NAV, KC_SPC), LT(_MOUSE, KC_TAB),    LT(_SYM, KC_ENT), LT(_NUM, KC_BSPC), LT(_FUN, KC_DEL)
                                            //`----------------------------------------------------'  `------------------------------------------------------'
 ),
 ...
 [_GAME] = LAYOUT_split_3x5_3(  // Gaming
  //,--------------------------------------------------.                    ,-------------------------------------------------------------------.
       KC_TAB,    KC_Q,    KC_W,    KC_E,          KC_R,                         KC_Y,         KC_U,         KC_I,         KC_O,         KC_SCLN,
  //|--------+--------+--------+--------+--------------|                    |--------+-------------+-------------+-------------+----------------|
  ...
  //|--------+--------+--------+--------+--------------+--------|  |--------+--------+-------------+-------------+-------------+----------------|
                                  KC_ESC, MO(_GAME_NUM),  KC_SPC,     KC_ENT, KC_BSPC,    TG(_GAME)
                             //`--------------------------------'  `-------------------------------'
 ),
...
const uint16_t PROGMEM scln_combo[] = { LSFT_T(KC_O), LCTL_T(KC_A), COMBO_END };
const uint16_t PROGMEM coln_combo[] = { LALT_T(KC_I), LGUI_T(KC_E), COMBO_END };
