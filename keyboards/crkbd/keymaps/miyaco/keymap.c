...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_split_3x6_3(  // Default (大西配列)
  //,--------------------------------------------------------------------------------.                                 ,--------------------------------------------------------------------------------.
       KC_TAB,         KC_Q,         KC_L,         KC_U,       KC_COMM,        KC_DOT,                                            KC_F,          KC_W,         KC_R,         KC_Y,         KC_P, KC_SLSH,
  //|--------+-------------+-------------+-------------+--------------+--------------|                                 |--------------+--------------+-------------+-------------+-------------+--------|
  ...
  //|--------+-------------+-------------+-------------+--------------+--------------|                                 |--------------+--------------+-------------+-------------+-------------+--------|
      KC_LSFT,         KC_Z,         KC_X,         KC_C,          KC_V,       KC_SCLN,                                            KC_G,          KC_D,         KC_M,         KC_J,         KC_B, KC_BSPC,
  //|--------+-------------+-------------+-------------+--------------+--------------+--------------|  |---------------+--------------+--------------+-------------+-------------+-------------+--------|
